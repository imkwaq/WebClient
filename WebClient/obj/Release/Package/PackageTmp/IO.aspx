    ...
    <%--<div class="container">
        <div class="row">
            <div class="container col-md-4">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <asp:TextBox ID="TextBox1" runat="server" AutoCompleteType="Disabled" CssClass="form-control center-block"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="container col-md-8">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <asp:TextBox ID="TextBox2" runat="server" AutoCompleteType="Disabled" CssClass="form-control center-block"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
