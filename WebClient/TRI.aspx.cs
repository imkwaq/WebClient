    ...
    public partial class TRI : System.Web.UI.Page
    {
        ...
        protected void NextTRI_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (int.Parse(m_np1tri.Text) > GV.nv || int.Parse(m_nm1tri.Text) > GV.nv ||  //если значения введенных узлов
                    int.Parse(m_np2tri.Text) > GV.nv || int.Parse(m_nm2tri.Text) > GV.nv ||  //превышают общее число узлов или они равны
                    int.Parse(m_np1tri.Text) == int.Parse(m_nm1tri.Text) ||
                    int.Parse(m_np2tri.Text) == int.Parse(m_nm2tri.Text))
                {
